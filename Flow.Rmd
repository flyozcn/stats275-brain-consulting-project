...
Here we first look at brain region scores of baseline SPECT scan.
...
About 120 patients have 1 or 2 missing values but about 90 patients have more than 100 missing values. We will remove those patients and do simple mean imputation for the rest.
...
ggplot(data=regions,aes(x=as.factor(name),y=score,fill=responder)) + 
...
Even the magical tSNE method can't produce a reasonable embedding.
